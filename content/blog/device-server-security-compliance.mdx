...
<details>
<summary>Enable full event logging (realm settings)</summary>
...
<details>
<summary>Wazuh agent — read Keycloak log output</summary>
...
<details>
<summary>Wazuh rules — login failures and admin privilege changes</summary>
...
<details>
<summary>Fleet result log configuration</summary>
...
<details>
<summary>Filebeat — forward Fleet logs to Wazuh</summary>
...
<details>
<summary>Wazuh agent — read OpenEDR telemetry and Windows Security Event Log</summary>
...
<details>
<summary>Wazuh rules — MITRE ATT&CK credential access detection</summary>
...
<details>
<summary>Wazuh active response configuration</summary>
...
<details>
<summary>Fail2ban log ingestion and audit rules</summary>
