---
title: "Zero to Deployed: The Modern Dev Stack That Just Works"
excerpt: "A practical guide to setting up Terminal, VS Code, GitHub, Claude Code, Vercel, and Supabase — from a simple blog with CMS to a full table management app."
...
The modern indie dev stack is genuinely remarkable. In 2026, a single developer can go from blank directory to a production app with authentication, a database, content management, and CI/CD — all for free, in a few hours. This guide walks you through each tool with real AI prompts you can drop in immediately.
...
| Tool | Role | Free Tier |
|---|---|---|
| **Terminal** | Local dev environment | ✓ Always free |
| **VS Code** | Editor + AI integration | ✓ Always free |
| **GitHub** | Source control + CI | ✓ Unlimited public repos |
| **Claude Code** | AI pair programmer | ✓ Free tier available |
| **Supabase** | DB + Auth + Storage | ✓ 2 projects, 500MB |
| **Vercel** | Hosting + CDN | ✓ 100GB bandwidth/mo |
| **Penpot** | UI design tool | ✓ Always free |
| **CodeSandbox** | Cloud dev environment | ✓ Free personal use |
