...
export const TECH_TOOLS: TechTool[] = [
  ...
  { name: "Open Technology App", icon: "⚙️", logo: "/logos/opentechnologyapp.png", category: "Workflow Management", url: "https://www.opentechnologyapp.com", description: "Item, task, and workflow management built on open source" },
