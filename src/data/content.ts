...
export const TECH_TOOLS: TechTool[] = [
  ...
  { name: "Pika Pods",       icon: "🫛",                                  category: "Open Source App + API Hosting",   url: "https://pikapods.com",              description: "Managed app hosting with one-click containers" },
  { name: "Digital Ocean",   icon: "🌊",                                  category: "Open Source App + API Hosting",   url: "https://digitalocean.com",          description: "Simple cloud VPS hosting for apps, blogs & APIs" },
  ...
  { name: "Cloudflare",      icon: "🟠",                                  category: "Corporate App + API Hosting",     url: "https://cloudflare.com",            description: "CDN, edge hosting, and Pages for static sites" },
